...
const TABLE_HEAD = [
  ...
  { id: 'manager', label: 'LÍNH VỰC', align: 'left' },
  { id: 'manager', label: 'SỐ TIỀN KÊU GỌI', align: 'left' },
  { id: 'createDate', label: 'NGÀY TẠO', align: 'left' },
  { id: '', label: 'THAO TÁC', align: 'center' }
];

export default function CallingTimeIsOverProjectTable() {
  ...
  return (
    <>
      ...
      <KrowdTable
        headingTitle="DỰ ÁN ĐÃ QUÁ HẠN ĐẦU TƯ"
        header={TABLE_HEAD}
        getData={getData}
